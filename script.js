...
// Animar contagem de números nas estatísticas
...
// Inicializar animação dos números quando o DOM carregar
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', animateStatsNumbers);
} else {
    animateStatsNumbers();
}